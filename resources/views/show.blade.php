<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure beatae facilis facere fugit consequatur corporis. Corporis, iusto. Nisi at, molestiae recusandae perferendis ipsum quibusdam doloremque dolorem, quisquam animi iure veritatis!
                </div>
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div class="flex md:hidden mt-4">
                        ...
                        <button class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3 -mx-5">
                            Vote
                        </button>
                    </div>
                </div>
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button" class="flex items-center justify-center h-11 w-full md:w-1/2 text-sm bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                                Post Comment
                            </button>
    ...
    <div class="comments-container relative space-y-6 md:ml-22 pt-4 my-8 mt-1">
        <div class="comment-container relative bg-white rounded-xl mt-4">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
        ...
        <div class="comment-container is-admin relative bg-white rounded-xl mt-4">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
