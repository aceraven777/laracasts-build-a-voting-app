    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                <div class="flex-none mx-4 mx-2 md:mx-0">
                    <a href="#">
        ...
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia est eligendi laborum officia architecto adipisci repellendus, odio nesciunt totam, assumenda obcaecati accusantium reiciendis voluptate eaque repellat ipsum magni dolor dignissimos.
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex md:hidden mt-4">
                            ...
                            <button class="w-20 bg-blue text-white border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3 -mx-5">
                                Voted
                            </button>
                        </div>
                    </div>
